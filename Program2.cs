...
// Necessário para usar 'Path'
using System.IO;

// Necessário para usar 'Assembly'
...
namespace ConsoleLances
{
    class Program
    {
        ...
        private static int id_franquia = 8;


        // Nome da franquia
        private static string nome_franquia = "Franquia São Gonçalo";
        ...
        // URL que gera link para PERFIL EXATO
        private static string url_mensagem_perfil_exato = "http://www.superestagios.com.br/franquia/conteudo/gera_whats_perfil_exato.php";

        // URL que gera link para PERFIL EXATO
        private static string url_mensagem_entrevista = "http://www.superestagios.com.br/franquia/conteudo/gera_whats_entrevista.php";

        // URL que gera link para PERFIL EXATO
        private static string url_mensagem_infos = "http://www.superestagios.com.br/franquia/conteudo/gera_whats_infos.php";

        // URL que gera link para PERFIL EXATO
        private static string url_mensagem_tc = "http://www.superestagios.com.br/franquia/conteudo/gera_whats_tc.php";
        ...
        static void enviar_mensagens(IWebDriver driver, string url, int id_franquia, int ordem)
        {
            string id_mensagem;
            ...
            do
            {
                ...
                id_mensagem = abrir_mensagem_perfil_exato(driver, url, id_franquia, ordem);
        ...
        static string abrir_mensagem_perfil_exato(IWebDriver driver, string url, int id_franquia, int ordem)
        {
            ...
            try
            {
                ...
                driver.Navigate().GoToUrl(url + "?id_franquia=" + id_franquia + "&ord=" + ordem);
                ...
                try
                {
                    ...
                    Console.WriteLine("O id da mensagem é: " + id_mensagem);
                    ...
                    else
                    {
                        ...
                        detectar_pagina_whatsapp_aberta(driver, url, id_franquia, ordem);
                ...
                // Se depois de 1 min o link não carregar
                catch (WebDriverTimeoutException)
                {
                    // Chama a função novamente,
                    // Essencialmente, criando uma RECURSÃO
                    return abrir_mensagem_perfil_exato(driver, url, id_franquia, ordem);
                }
            }
            catch
            {
        ...
        static void detectar_pagina_whatsapp_aberta(IWebDriver driver, string url, int id_franquia, int ordem)
        {
            WebDriverWait esperar_10_segundos = new WebDriverWait(driver, TimeSpan.FromSeconds(10));
                ...
                for (int i = 0; i <= 5; i++)
                {
                    ...
                    catch (WebDriverTimeoutException)
                    {
                        ...
                        catch (WebDriverTimeoutException)
                        {
                            ...
                            if (i >= 5)
                            {
                                abrir_mensagem_perfil_exato(driver, url, id_franquia, ordem);
                            }
                            else
                            {
        ...
        static void enviar_mensagem(IWebDriver driver, string url, string id_mensagem)
        {
            ...
            do
            {
                try
                {
                    ...
                    botao_enviar_mensagem = esperar_10_segundos.Until(d => d.FindElement(By.ClassName("_4sWnG"))); //_4sWnG //_1E0Oz
                }
                catch (WebDriverTimeoutException)
                {
                    ...
                    try
                    {
                        ...
                        aviso_numero_nao_encontrado = esperar_10_segundos.Until(d => d.FindElement(By.ClassName("_3J6wB"))); //_3J6wB  //_3NCh_
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(DateTime.Now.ToString("HH:mm:ss") + " - Id da franquia: " + id_franquia + ".\n");
            ...
            Console.WriteLine("\n\nIniciando envio de mensagens de ENTREVISTA\n\n");
            enviar_mensagens(driver, url_mensagem_entrevista, id_franquia, ordem);


            Console.WriteLine("\n\nIniciando envio de mensagens de TERMO DE COMPROMISSO\n\n");
            enviar_mensagens(driver, url_mensagem_tc, id_franquia, ordem);


            Console.WriteLine("\n\nIniciando envio de mensagens de INFORMAÇÕES\n\n");
            enviar_mensagens(driver, url_mensagem_infos, id_franquia, ordem);


            Console.WriteLine("\n\nIniciando envio de mensagens de PERFIL EXATO\n\n");
            enviar_mensagens(driver, url_mensagem_perfil_exato, id_franquia, ordem);
